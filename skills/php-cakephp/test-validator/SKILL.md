  ...
  PreToolUse:
    - matcher: "Read|Grep|Glob"
      hooks:
        - type: command
          once: true
          command: $HOME/.claude/scripts/hooks/load-config-context.sh php-cakephp-test-validator skill ".constraints.testing,.constraints.schema,.constraints.business_rules"
---
